...
export function Footer() {
  return (
    <div className="bg-bgFooter px-6 pt-11 pb-5 text-white max-sm:flex max-sm:flex-col">
      ...
      <div className="flex justify-between px-2 font-poppins max-sm:flex-col max-sm:text-center">
        ...
        <div className="text-right font-bold max-sm:mt-5 max-sm:text-center">
          <p>
